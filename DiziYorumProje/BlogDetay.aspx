                ...
                <div class="col-md-8 single-main">
                    <div class="single-grid">
                        ...
                        <asp:Repeater ID="Repeater1" runat="server">
                            <ItemTemplate>
                                <img src="<%#Eval("BLOGGORSEL") %>" alt="" style="height: 400px; width: 700px; margin-bottom: 20px" />
                    ...
                    <div class="content-form">
                        ...
                        <form runat="server">
                            ...
                            <textarea placeholder="Yorumunuz" id="TextArea1" cols="20" rows="2" runat="server"></textarea>

                            <asp:Button ID="BtnYorumYap" runat="server" Text="Yorum Yap" OnClick="Button1_Click" />
