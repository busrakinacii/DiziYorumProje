    ...
    <div class="contact-content">
        <div class="container">
            ...
            <div class="contact-details">
                <form runat="server" style="margin: auto">
            ...
            <div class="contact-details">
                <div class="col-md-6 contact-map">
                    ...
                    <div style="max-width: 100%; list-style: none; transition: none; overflow: hidden; width: 500px; height: 500px;">
                        ...
                        <a class="google-map-code-enabler" rel="nofollow" href="https://www.bootstrapskins.com/themes" id="get-map-data">premium bootstrap themes</a><style>
                                                                                                                                                                         #my-map-display img {
                                                                                                                                                                             max-height: none;
